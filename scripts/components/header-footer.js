...
const contact = "form.html"
const homeText = "Inicio"
const aboutText = "Acerca de"
const eventsText = "Eventos"
...
<nav class="buttons">
    ...
    <a class="desktop" href=${home}>${homeText}</a>
    ...
    <a class="desktop" href=${about}>${aboutText}</a>
